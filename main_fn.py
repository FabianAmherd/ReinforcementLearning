import gym
from deepqlearning_tf import DeepQNetwork, Agent
import numpy as np
...
def stack_frames(stacked_frames, frame, buffer_size):
  if stacked_frames is None:
    ...
    stacked_frames[0:buffer_size-1, :] = frame
...
if __name__ == '__main__':
  ...
  agent = Agent(gamma=0.99, epsilon=1.0, alpha=0.0025, input_dims=(180,160,4), n_actions=3, mem_size=7000, batch_size=32)
  if load_checkpoint:
    agent.load_models()
  scores = []
  numGames = 200
