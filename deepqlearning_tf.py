...
class DeepQNetwork(object):
    def __init__(self, lr, n_actions, name, fc1_dims=256, input_dims=(210,160,4), chkpt_dir=r'C:\Users\fabia\Desktop\AI\Projects\ReinforcementLearning\Temp\dqn\q_eval\deepqnet.ckpt'):
        self.lr = lr
        self.name = name
...
class Agent(object):
    def __init__(self, alpha, gamma, mem_size, n_actions, epsilon, batch_size, replace_target=5000, input_dims=(210,160,4),
                q_next_dir=r'C:\Users\fabia\Desktop\AI\Projects\ReinforcementLearning\Temp\dqn\q_next\deepqnet.ckpt', q_eval_dir=r'C:\Users\fabia\Desktop\AI\Projects\ReinforcementLearning\Temp\dqn\q_eval\deepqnet.ckpt'):
    ...
    def store_transition(self, state, action, reward, state_, terminal):
        ...
        self.new_state_memory[idx] = terminal
