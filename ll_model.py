...
class PolicyGradientAgent(object):
  def __init__(self, lr, gamma=0.95, n_actions=4, l1_size=16, l2_size=16, input_dims=128, chkpt_dir='tmp/checkpoints'):
    self.lr = lr
    self.gamma = gamma
    ...
    self.chkpt_file = os.path.join(chkpt_dir, 'policy_network.ckpt')
